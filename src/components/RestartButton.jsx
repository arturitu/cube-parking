...
const RestartButton = () => {
  ...
  return (
    <div className="w-full flex justify-end px-12">
      <button
        onClick={resetLevel}
        className="pointer-events-auto flex items-center gap-3 px-8 py-3.5 rounded-full bg-brandRed hover:bg-brandRed/90 transition-all text-[11px] font-black uppercase tracking-[0.2em] text-white shadow-xl shadow-brandRed/20 group"
      >
        <span>Restart Level</span>
        <svg
          viewBox="0 0 24 24"
          className="w-5 h-5 fill-none group-hover:rotate-180 transition-transform duration-500"
        >
          <path
