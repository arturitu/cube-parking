  ...
  return (
    <div className="fixed inset-0 pointer-events-none select-none flex flex-col text-white font-sans">
      ...
      <div className="mt-auto flex justify-center pb-8">
        <button
          onClick={resetLevel}
          className="pointer-events-auto px-10 py-3 rounded-full border border-white/10 bg-white/5 hover:bg-white/10 transition-all text-[10px] font-bold uppercase tracking-[0.2em] opacity-60 hover:opacity-100 text-white"
        >
          Restart Level
        </button>
      </div>
